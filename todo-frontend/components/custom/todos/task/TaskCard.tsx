...
const handleMarkComplete = (e: React.MouseEvent) => {
  ...
  return (
    <>
      <div className="group max-h-72 overflow-y-auto p-4 rounded-xl border bg-zinc-200 dark:bg-zinc-800 flex items-start justify-between hover:shadow-sm transition"
