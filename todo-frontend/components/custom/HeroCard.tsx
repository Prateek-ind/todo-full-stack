...
const HeroCard = () => {
  return (
    <div className="relative ">
            ...
            <div className="absolute -inset-4 bg-gradient-to-r from-zinc-300 to-zinc-100 dark:from-zinc-700 dark:to-zinc-900 blur-2xl opacity-50 rounded-3xl"></div>
            <div className="relative bg-white dark:bg-zinc-800 rounded-2xl shadow-xl p-6 space-y-4">
